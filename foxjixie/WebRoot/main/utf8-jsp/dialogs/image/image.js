...
//                console.log("isJsonp："+isJsonp);
                        ...
                        try {
                           ...
                           // console.log("r.responseText"+r.responseText);
                            ...
                            if(r.responseText.indexOf('ue_separate_ue') != -1) {
                                ...
                                //console.log("zz-list:"+list[0].url);
                                _this.pushData(list);
        ...
        pushData: function (list) {
            var i, item, img, icon, _this = this,
            	...
            	/*获取某段字符后面的字符*/
            	function getCaptionzz(obj){
            		var index=obj.lastIndexOf("\foxjixie");
...
//                    console.log("     list[i].url:"+list[i].url);
//                    console.log("getc list[i].url:"+list[i].url.split("foxjixie")[1]);
                    
//                    img.setAttribute('src', urlPrefix + list[i].url.split("foxjixie")[1]+(list[i].url.indexOf('?') == -1 ? '?noCache=':'&noCache=') + (+new Date()).toString(36) );
